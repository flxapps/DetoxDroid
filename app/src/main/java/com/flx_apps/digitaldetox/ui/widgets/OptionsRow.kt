...
/**
 * Displays a set of mutually exclusive options as [FilterChip]s in a [FlowRow]. The selected chip
 * is rendered in full primary color with a check mark — the default secondaryContainer is too

...
if [ ! -f "platform-tools/adb" ]; then
    ...
    download_file "https://dl.google.com/android/repository/platform-tools-latest-darwin.zip" "platform-tools-latest-darwin.zip"
    unzip -o platform-tools-latest-darwin.zip >/dev/null
fi
